...
public class API_BasketProduct extends BaseModel implements BaseModel.ResponseListener {
    private String Api_Path="Product/ListProduct";

    private ApplicationClass.API_Listener api_listener;

    public API_BasketProduct(Context context) {
