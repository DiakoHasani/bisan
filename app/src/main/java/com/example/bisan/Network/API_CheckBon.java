...
public class API_CheckBon extends BaseModel implements BaseModel.ResponseListener {
    private String Api_Path="Order/CheckBon";

    private ApplicationClass.API_Listener api_listener;

    public BaseParam in_id=new BaseParam("serial","","","string","",true);

    public API_CheckBon(Context context) {
